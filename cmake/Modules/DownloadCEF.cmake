...
function(download_cef version download_dir)
  ...
  if(NOT CMAKE_SYSTEM_NAME STREQUAL "Linux")
    message(FATAL_ERROR "Attempted to utilize DownloadCEF on a non-Linux system!")
  endif()
  ...
  set(CEF_DISTRIBUTION "cef_binary_${version}_${CEF_PLATFORM}")

  # Allow for specifying the minimal distribution
  if(USE_CEF_MINIMAL_DISTRIBUTION)
    set(CEF_DISTRIBUTION "${CEF_DISTRIBUTION}_minimal")
  endif()
  ...
  if(NOT IS_DIRECTORY "${CEF_ROOT}")
    ...
    set(CEF_DOWNLOAD_FILE_PATH "${CEF_DOWNLOAD_DIR}/${CEF_DOWNLOAD_FILENAME}")

    # No need to download the archive again if we already have the file
    if(NOT EXISTS "${CEF_DOWNLOAD_FILE_PATH}")
      ...
      message(STATUS "You may use `CEF_ROOT` to specify a local path for CEF.")
      message(STATUS "=====!!!NOTE!!!=====")

      # Download SHA1 for use in file()
      file(DOWNLOAD "${CEF_DOWNLOAD_URL_ESCAPED}.sha1" "${CEF_DOWNLOAD_FILE_PATH}.sha1")
      file(READ "${CEF_DOWNLOAD_FILE_PATH}.sha1" CEF_SHA1)

      file(
        DOWNLOAD "${CEF_DOWNLOAD_URL_ESCAPED}" "${CEF_DOWNLOAD_FILE_PATH}"
    ...
    message(STATUS "Extracting ${CEF_DOWNLOAD_FILE_PATH}...")
    execute_process(
      COMMAND ${CMAKE_COMMAND} -E tar xvf "${CEF_DOWNLOAD_FILE_PATH}" WORKING_DIRECTORY ${CEF_DOWNLOAD_DIR}
    )
  endif()
endfunction()
